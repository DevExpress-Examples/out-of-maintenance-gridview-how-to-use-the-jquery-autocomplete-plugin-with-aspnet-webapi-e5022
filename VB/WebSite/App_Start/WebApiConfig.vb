...
Namespace DXWebApplication5.App_Start
	Friend Class WebApiConfig
		Public Shared Sub Register(ByVal configuration As HttpConfiguration)
			configuration.Routes.MapHttpRoute("DefaultApi", "api/{controller}/{id}", New With {Key .id = RouteParameter.Optional})
		End Sub
	End Class
End Namespace