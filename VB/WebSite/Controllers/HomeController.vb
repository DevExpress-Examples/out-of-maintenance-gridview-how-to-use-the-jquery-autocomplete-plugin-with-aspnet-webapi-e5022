...
Namespace DXWebApplication5.Controllers
	Public Class HomeController
		Inherits Controller
		Private clist As List(Of MyModel) = CustomerList.GetTypedListModel()
		...
		End Function
		Public Function UpdateRecordFromGrid(<ModelBinder(GetType(DevExpressEditorsBinder))> ByVal updateModel As MyModel) As ActionResult
